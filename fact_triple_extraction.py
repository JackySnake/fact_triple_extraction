...
MODELDIR="model/ltp_data_v3.4.0/"
...
segmentor = Segmentor()
#segmentor.load(os.path.join(MODELDIR, "cws.model"), 'dic')
segmentor.load_with_lexicon(os.path.join(MODELDIR, "cws.model"), 'dic')
